...
class box_v2(object):
    ...
    def plan(self, state, opt_t=1.0):
        ...
        for i in range(self._N):
            ...
            traj_quat_point = self.get_cartesian_state(state, euler=False).tolist() # TODO
            traj_quat_point[kPosZ] = 0
            traj_quat_point[kVelZ] = 0
    ...
    def get_cartesian_state(self, state, euler=True):
        if not euler:
            ...
            cstate[kWx:kWy+1] = self.get_euler(state)[0:1]
    ...
    def get_position(self, state):
        ...
        pos[2] = self.pivot_point[2] - state[kTheta]
        return pos
